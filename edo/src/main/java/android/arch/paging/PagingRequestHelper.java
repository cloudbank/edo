 ...
 *     // TODO replace with an ioExecutor from your application
 *     Executor ioExecutor = Executors.newSingleThreadExecutor();
 *     PagingRequestHelper helper = new PagingRequestHelper(ioExecutor);
...
public class PagingRequestHelper {
  ...
  public static final class StatusReport {
     ...
     * @return The {@link Throwable} returned by the failing request with the given type or {@code
