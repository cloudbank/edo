...
class ArtActivity : DaggerAppCompatActivity() {
    ...
    private fun createViews() {
        ...
        artViewModel.networkState.observe(this, Observer { adapter.setNetworkState(it) })
    }
    ...
    private fun initSwipeToRefresh() {
        artViewModel.refreshState.observe(this, Observer { swipe_refresh.isRefreshing = it == NetworkState.LOADING })
